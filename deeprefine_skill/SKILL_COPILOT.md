...
description: >-
  ...
  graphify search instead of FAISS, session LLM for judgement, and deeprefine
  apply for graph writes.
allowed-tools: shell
license: MIT
---
...
7. Ignore pending history and refine only one latest query when unrefined
